...
export function SendMessages({sendMess, text, setMessageText, handleEvent, innerRef}) {
    ...
    return (
        <section className={style.textArea} ref={innerRef}>
            ...
            <textarea placeholder='Enter your messages' onKeyDown={handleEvent} value={text} onChange={(e) => setMessageText(e.target.value)} name="messages" id='textarea' type='text' className={style.input} rows="1" ></textarea>
