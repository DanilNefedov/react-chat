...
export function Form( {handleClick} ) {
    
    // const {nameForm, nameButton, link, nameLink} = formProps{formProps}
    ...
    return(
        ...
        <form action="" className={style.form}>
            ...
            <h2 className={classNames(style.headerForm, 'header')}>Reg</h2>
            ...
            className={style.regBnt}>ss</button>
